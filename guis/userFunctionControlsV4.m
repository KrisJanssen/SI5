...
firstUserFcn = hModel.USER_FUNCTIONS_EVENTS{1};
...
firstOverrideFcn = hModel.USER_FUNCTIONS_OVERRIDE_FUNCTIONS{1};
...
handles.uftOverride = scanimage.UserFunctionsTable(hModel,handles.tblOverrideFcns,...
    recordFieldInfo,'Function',@()hModel.USER_FUNCTIONS_OVERRIDE_FUNCTIONS,@()'userFunctionsOverride',...
