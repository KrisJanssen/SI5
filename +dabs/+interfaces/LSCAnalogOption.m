  ...
  %% OBJECT LIFECYCLE    
    ...
    methods (Access=protected,Hidden)
        ...
        function moveStartHook(obj,absTargetPosn)            
            ...
            if obj.analogCmdEnable
                ...
                outVoltage = obj.analogCmdPosn2Voltage(absTargetPosn) - obj.analogVoltageOffset;
    ...
    methods (Hidden)
        ...
        function initializeAnalogOption(obj,varargin)
            ...
            pvCell = most.util.filterPVArgs(varargin,{'analogCmdBoardID' 'analogCmdChanIDs' 'analogSensorBoardID' 'analogSensorChanIDs' 'hAOBuffered'});
            ...
            if ~isempty(obj.hAILSC)
                ...
                initialSensorVoltage = max(measRange(1),min(measRange(2),initialSensorVoltage));
