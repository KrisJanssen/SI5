classdef Class < hgsetget
    %CLASS Current 'standard' Dabs class
    %
    %% NOTES
    %   5/4/14: Copied from DClass and renamed to Class.
    %    
    %   TODO: Consider if it makes sense to factor filterPropValArgs & extractPropValArgMap out into utility functions -- they don't really need to be Class methods..
    ...
    %   TODO: Consider subclassing MException, to make DException -- instead of packing utility functions here. But how to make this available to all Class instances?
    %
    %% ************************************************************************    
    ...
    methods(Access=protected)
        ...
        function ensureClassDataFile(obj,initValStruct,className)
            ...
            most.Class.ensureClassDataFileStatic(className,initValStruct);            
        end
        ...
        function backupClassData(obj,className)
            ...
            most.Class.backupClassDataFileStatic(className);
        end
        ...
        function val = getClassDataVar(obj,varName,className)
            ...
            val = most.Class.getClassDataVarStatic(className,varName,tfSearchSuperClasses);     
        end
        ...
        function setClassDataVar(obj,varName,val,className)
           ...
           %
            ...
            most.Class.setClassDataVarStatic(className,varName,val,tfSearchSuperClasses);
        end
   ...
   methods (Static, Hidden)
       ...
       function classDataFileName = classDataFileNameStatic(className)
           classDataFileName = [most.Class.classPrivatePath(className) '_classData.mat'];
...
error('Class:ClassDataVarNotFound',...
